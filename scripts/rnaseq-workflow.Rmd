...
```{r read in samples}
samples <- read_csv("../output/rnaseq_samples.csv")
```
...
```{r define ref files}
indexDir <- file.path(getwd(), "output", "quant", "sc_ensembl_index")
indexDir <- str_remove(indexDir, "scripts/")
